...
export default async function Home({searchParams}:{searchParams:Promise<{lang?:string}>}){
 ...
 const t=es?{
  ...
  why:'POR QUÉ PAIRVOICE',whyTitle:'Más resultado. Menos fricción.',whyLead:'Antes de invertir tiempo, deberías saber cuánto puedes ganar, qué necesitas hacer y qué ocurre después.',
  ...
  why:'WHY PAIRVOICE',whyTitle:'More outcome. Less friction.',whyLead:'Before you spend time, you should know what you can earn, what the work requires, and what happens next.',
